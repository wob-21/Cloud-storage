...
// @author      wob
// @version     3.0
// @description ✅请先到【扩展管理】中打开【开发人员模式】才能正常使用！✨[只支持在国外使用，因为使用的是Google的API，国内无法响应] | 划词后朗读并在鼠标停留区域时显示翻译卡片（翻译为中文），鼠标离开划词范围立即关闭悬浮翻译并清除划词缓存，单词、句子都能翻译。划词翻译的句子不要太长，太长的话可能无法翻译！
// @match       *://*/*
