...
// @author       wob
// @version      4.0
// @description  ✅请先到【扩展管理】中打开【开发人员模式】才能正常使用！✨使用我自己搭建的 translate API，实现划词后自动朗读且显示悬浮翻译卡片，鼠标一旦移出划词区域，立即关闭翻译卡片并清除划词高亮，更轻、更快、更稳定！支持句子、单词翻译，朗读多国语言，国内外皆可使用！
// @match        *://*/*
...
(function () {
  ...
  function strictMouseLeaveCheck(e) {
    ...
    if (!inArea) {
      ...
      // ✅鼠标移除划词范围则清空选中文本，如不想清空选中文本，把这段注释掉就行（多行注释：Ctrl+K 或 Ctrl+Shft+K）
