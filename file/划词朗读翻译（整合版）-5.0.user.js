...
// @author       wob
// @version      5.0
// @description  ♻整合了有道的API和我的translate API接口，根据划词内容智能选择翻译API：纯英文单词使用有道词典API（英译中），其他所有情况（句子、非英文单词）则使用我搭建的translate API。✨实现划词自动朗读并显示悬浮翻译卡片。鼠标一旦移出划词区域，立即关闭翻译卡片并清除划词高亮，不想使用该脚本时按 "Ctrl+空格"快捷键 【关闭/开启】该脚本，更轻、更快、更稳定！国内外皆可使用！
// @match        *://*/*
